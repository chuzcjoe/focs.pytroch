...
class FPN(nn.Module):
    def __init__(self, features=256, use_p5=True):
        ...
        self.p_3 = nn.Conv2d(512, features, kernel_size=1)
        self.p_4 = nn.Conv2d(1024, features, kernel_size=1)
        self.p_5 = nn.Conv2d(2048, features, kernel_size=1)
    ...
    def forward(self, x):
        ...
        P4 = P4 + self.upsample([P5,C4])
        P3 = P3 + self.upsample([P4,C3])
